...
class TestMysqlStorage extends FunSuite with BeforeAndAfterAll with BeforeAndAfterEach {
  ...
  test("operations should be kept in a history") {
    ...
    table1Timeline(5).newValue.equalsValue(NullValue())
